            ...
            <div class="col-md-9">
                ...
                <div class="row mb-3">
                    <form method="POST" action="{{ route('verification.resend') }}">
                        ...
                        <button type="submit" class="btn btn-primary">{{ __('Resend email verification link') }}</button>
                    </form>
                </div>
                @endif
                ...
                <form method="POST" action="{{ route('profile.simple-data', ['user' => auth()->user()->id + 2]) }}"
                    ...
                    <div class="row">
                        ...
                        <x-text-input :col="'6'" :mb="'3'" :field="'email'" :default="auth()->user()->email" :label="__('Email')" :readonly="true" />
